...
<template>
  <form @submit.prevent="handleSubmit" class="bg-white p-12 rounded-lg shadow-md w-full max-w-md">
    ...
    <FormInput v-model="password" id="password" type="password" label="Password:" placeholder="Enter your password"
      required />
    ...
    <button type="submit"
      class="w-full py-2 bg-green-600 hover:bg-green-700 text-white rounded-md font-semibold transition-colors duration-300">Login</button>
